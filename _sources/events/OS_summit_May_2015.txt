...
- prereqs at start (to start this guide you should have done this, be familiar
  with this)
...
- Reviewing
  ...
  - Review Guide should be better propogated
...
- New contributors
  ...
  - tutorial for contributing where writers can work in a sandbox = smaller
    repo to download, changes don't matter
  - make a 5 minute video

- Encouraging technical content for speciality guides
  - each dev team should have a docs liason
...
- Update How To and How To for First Timers on wiki; make the latter a tutorial
  that works with a sandbox repo for trying out the tools
...
- For each book where it makes sense:
  ...
  - prereqs at start (to start this guide you should have done this, be
    familiar with this)
  - next steps at end (see this guide for the next things you can do)
  - describe the current book and the other books at the top of each book so
    people know where they are and if they are in the correct place
